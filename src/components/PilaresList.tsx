                ...
                {pilaresData.map((pilar, index) => {
                    ...
                    return (
                        <div
                            ...
                            className="group rounded-2xl bg-white p-6 shadow-sm transition-all duration-300 hover:shadow-xl cursor-pointer">
                            <div
                                className={cn(
                                    'h-14 w-14 mb-4 flex items-center justify-center rounded-xl transition-all duration-300 group-hover:scale-110',
                                    classes.bg,
                                    classes.bgHover
                                )}>
                                {Icon && (
                                    <Icon
                                        className={cn(
                                            'h-7 w-7 transition-colors group-hover:text-white',
                                            classes.text
                                        )}
                                    />
                                )}
                            ...
                            <span className="text-xs text-azul font-semibold mt-4 inline-block opacity-0 group-hover:opacity-100 transition-opacity">
                                Ver mais
                            </span>
                        </div>
                    )
                ...
                createPortal(
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
                        <div
                            ...
                            aria-hidden="true"
                        />
                        <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-200">
                            <div className="p-6 sm:p-8">
                                <div className="flex justify-between items-start mb-6">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <h3 className="text-xl sm:text-2xl font-semibold text-grafite pr-8">
