    ...
    return (
        <>
            ...
            <Dialog open={isOpen} onOpenChange={setIsOpen}>
                <DialogContent className="max-w-6xl w-[98vw] h-[95vh] sm:h-[90vh] p-0 overflow-hidden bg-background border-none shadow-2xl sm:rounded-2xl block [&>button]:hidden">
                    <div className="flex flex-col h-full overflow-y-auto sm:overflow-hidden">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                <div className="flex-1">
                                    <DialogHeader className="text-left space-y-1">
                                        <DialogTitle className="text-xl font-medium text-grafite">
                                            {currentItem.alt}
                                        </DialogTitle>
                                        <DialogDescription className="text-sm text-gray-600 leading-relaxed text-left line-clamp-none sm:line-clamp-2">
                        ...
                        {/* Thumbnails Footer */}
                        <div className="h-20 min-h-[5rem] bg-gray-900 border-t border-gray-800 p-2 flex items-center justify-start gap-2 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-700 shrink-0">
                            {items.map((item, index) => (
                                <button
                                    key={index}
