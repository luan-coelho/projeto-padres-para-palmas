        ...
        {pilaresData.map((pilar, index) => {
          ...
          return (
            <div
              ...
              <h3 className="mb-2 text-xl font-semibold text-grafite">{pilar.title}</h3>
              <p className="text-sm text-grafite/70">{pilar.description}</p>
              <span className="mt-4 inline-block text-xs font-semibold text-azul opacity-0 transition-opacity group-hover:opacity-100">
                Ver mais
              </span>
            </div>
          )
        ...
        createPortal(
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
            <div
              ...
              aria-hidden="true"
            />
            <div className="relative z-50 w-full max-w-2xl animate-in overflow-hidden rounded-2xl bg-white shadow-2xl duration-200 zoom-in-95 fade-in">
              <div className="p-6 sm:p-8">
                <div className="mb-6 flex items-start justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="pr-8 text-xl font-semibold text-grafite sm:text-2xl">
